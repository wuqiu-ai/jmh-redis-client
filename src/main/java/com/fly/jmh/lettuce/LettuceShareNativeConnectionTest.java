...
/**
 * spring data redis lettuce共享连接模式
 * @author: peijiepang
 * @date 2019-10-24
 * @Description:
 */
...
public class LettuceShareNativeConnectionTest {
  ...
  public void init() {
    ...
    factory.setShareNativeConnection(true);//共享连接模式
  ...
  public static void main(String[] args) throws RunnerException {
    Options options = new OptionsBuilder().include(LettuceShareNativeConnectionTest.class.getSimpleName()).build();
